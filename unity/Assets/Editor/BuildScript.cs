...
public static class BuildScript
{
    ...
    private static void EnsureUrpPipeline()
    {
        ...
        const string rendererPath = "Assets/Settings/BjjRenderer.asset";
        const string pipelinePath = "Assets/Settings/BjjPipeline.asset";
    ...
    private static void ConfigurePlayerSettings()
    {
        ...
        PlayerSettings.productName = "BJJ";
        PlayerSettings.bundleVersion = "1.0";
        // Линейное пространство обязательно для HDR и ACES-тонмаппинга.
        PlayerSettings.colorSpace = ColorSpace.Linear;

        PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.Android, "com.crucian.bjj");
    ...
    private static string ResolveOutputPath()
    {
        ...
        if (!string.IsNullOrEmpty(custom))
        {
            ...
            string file = string.IsNullOrEmpty(name) ? "Bjj" : name;
            if (!file.EndsWith(".apk")) file += ".apk";
            return Path.Combine(custom, file);
        }

        return Path.Combine("build", "Bjj.apk");
    }
