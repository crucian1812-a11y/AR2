...
public class ModelImportSettings : AssetPostprocessor
{
    ...
    private void OnPreprocessModel()
    {
        ...
        // Модулям дома читаемость обязательна: дом склеивается из них в
        // рантайме (Mesh.CombineMeshes), а нечитаемый меш в собранном
        // приложении отдать треугольники не может — в редакторе это
        // работало бы, а на телефоне нет. Всем остальным читаемость не
        // нужна и стоит второй копии меша в памяти.
        mi.isReadable = assetPath.StartsWith(KoenigDir);
