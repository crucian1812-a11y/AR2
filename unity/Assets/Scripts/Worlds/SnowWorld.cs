...
public class SnowWorld : WorldBuilder
{
    ...
    protected override void Build()
    {
        ...
        Reserve(OnGround(-60f, -50f, 2.1f), 13f);
        Reserve(OnGround(-4f, 48f, 4f), 6f);
        BuildForest();
        ...
        // Висел на шести метрах надо льдом и был недосягаем вообще ничем:
        // прыжок поднимает на 3 м, а удар достаёт ещё на 1.6. Опущен так,
        // чтобы по нему попадали в прыжке, но не доставали с земли.
